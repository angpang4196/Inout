...
public class InoutVO {                              // 날짜 체크
	...
	// 날짜값을 문자열로 저장하려고 하는데 변수의 값을 직접 저장하면 날짜값이 유효한지 아닌지 알 수 없다.
	...
	// Object 클래스에 정의된 toString() method를 임의로 다 정의(재작성)한 것
	@Override
	public String toString() {
		return "InoutVO [strDate=" + strDate + ", strIO=" + strIO + ", intDanga=" + intDanga + ", intSu=" + intSu
				+ ", vat=" + vat + ", intTotal=" + intTotal + ", getStrDate()=" + getStrDate() + ", getStrIO()="
				+ getStrIO() + ", getIntDanga()=" + getIntDanga() + ", getIntSu()=" + getIntSu() + ", getVat()="
				+ getVat() + ", getIntTotal()=" + getIntTotal() + ", getClass()=" + getClass() + ", hashCode()="
